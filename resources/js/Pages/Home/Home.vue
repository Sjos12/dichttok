    ...
    <div class="bg-gray-900 h-screen">
        ...
        <container class="h-screen grid grid-cols-12">
            <div class="col-span-6 my-auto gap-y-5 grid items-center pb-12">
                ...
                <p>
                    Het platform om nieuwe gedichten te vinden, je eigen gedichten te uploaden en ze te delen met je vrienden.
                </p>
...
<!--                    <MockGedicht :show-tags="true" :gedicht="props.gedichten[4]"></MockGedicht>-->
            ...
            <div class="col-span-6 my-auto gap-y-5 grid items-center">
                ...
                <h2 class="text-white font-medium text-5xl leading-tight ">Een verzameling van honderden gratis
                    gedichten.</h2>
                                ...
                                <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis dolore eligendi ipsum, laborum magnam sed sint! At autem cupiditate doloremque facere fugiat reiciendis! Ab dolore laboriosam maiores saepe suscipit voluptatibus?
                                </p>
        ...
        <div class="relative bottom-0 w-full bg-gray-800 py-4 snap-start">
            <container class="mx-auto w-full">
                <small class="mx-auto text-center font-thin text-sm text-gray-300 ">Copyright Denzel Stellingwerf 2023.</small>
            </container>
        </div>
    </div>
